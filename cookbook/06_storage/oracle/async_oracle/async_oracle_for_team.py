"""Use Async Oracle as the database for a team.
Run `uv pip install openai duckduckgo-search newspaper4k lxml_html_clean agno sqlalchemy oracledb` to install the dependencies
"""
