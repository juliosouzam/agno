...
# Mapping from toolkit name -> high-level category.
# Categories follow https://docs.agno.com/tools/toolkits/overview
...
def get_tool_category(toolkit_name: str) -> str:
    """Resolve toolkit name to its doc-aligned category.

    Falls back to the raw toolkit_name if no mapping exists, so user-defined
    toolkits still produce a meaningful tool_type.
    """
    return TOOLKIT_CATEGORY_MAP.get(toolkit_name, toolkit_name)
