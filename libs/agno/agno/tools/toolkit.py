...
class Toolkit:
    # Tool type category for this toolkit (e.g., "search", "local", "data", "media").
    # Override in subclasses. See https://docs.agno.com/tools/toolkits/overview for categories.
    _tool_type: Optional[str] = None
